...
- **The ASYNC aperture's SHADER has never been looked at.** Its fragment shader was authored blind and its uniform defaults are guesses (G-5). It is the game's signature image and the one thing in the Site that cannot be judged by a test.

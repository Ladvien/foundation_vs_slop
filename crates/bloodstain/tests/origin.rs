...
//! blood thrown from a known point, landed by [`bloodstain::stain::stains`], read back through the
...
use bloodstain::origin::{Landing, area_of_origin};
use bloodstain::stain::{impact_at_plane, stain_shape};
use bloodstain::{BloodSettings, Wound, WoundKind, droplet, droplet_count, landing};

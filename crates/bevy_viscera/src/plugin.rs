...
use crate::strand::{Mesentery, Strand};
...
///
/// The plugin is a convenience, not the crate. [`crate::step`], [`crate::spill`] and
/// [`crate::tube_mesh`] are plain functions over plain data, so a headless search or an offline test

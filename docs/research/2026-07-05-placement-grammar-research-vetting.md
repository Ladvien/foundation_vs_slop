...
8. **F** Karth, I., Smith, A. M. "WaveFunctionCollapse is Constraint Solving in the Wild." *FDG* 2017. `10.1145/3102071.3110566` — **in the corpus**, converted and embedded; this entry said `[external]` until 2026-08-09, when a sweep found it indexed and confirmed it by reading page 1 (title, authors and the FDG'17 DOI all match). Establishes WFC = finite-domain CSP; the theoretical basis for the pluggable-solver architecture.

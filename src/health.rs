...
/// just above the unit figurine's head — the figurine is ~1.82 m tall (the manifest's render scale
/// applied to the base mesh), so the bar clears it with a small gap. Tune by eye via devshot.
const BAR_Y: f32 = 2.0;
